        ...
        return (
            <div className="card p-8">
                <div className="text-center">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 font-medium mb-2">Failed to load reports</p>
    ...
    if (reports.length === 0) {
        return (
            <div className="card p-12 text-center">
                ...
                <p className="text-gray-500 dark:text-gray-400 mb-2">No previous reports</p>
    ...
    return (
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                ...
                <button onClick={fetchReports} className="text-sm text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 flex items-center gap-2">
                    ...
                    <div key={report.id} className="card p-5 hover:shadow-lg transition-shadow">
                        ...
                        {isExpanded && (
                            <div className="pt-3 border-t border-gray-100 space-y-3 fade-in">
                                {/* All Symptoms */}
                                <div>
                                    <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-2">Symptoms Reported:</p>
                                ...
                                {report.diagnosis.possibleConditions?.length > 0 && (
                                    <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-2">Possible Conditions:</p>
                                ...
                                {report.diagnosis.overallAssessment && (
                                    <div>
                                        <p className="text-xs text-gray-500 dark:text-gray-400 font-medium mb-2">Assessment:</p>
                                        <p className="text-sm text-gray-600 dark:text-gray-400">{report.diagnosis.overallAssessment}</p>
                                    </div>
                                )}
                            </div>
                        )}
